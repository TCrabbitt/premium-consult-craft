...
const Hero = () => {
  return (
    <section className="pt-28 pb-16 md:pt-36 md:pb-24 px-4 gradient-bg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 md:space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold leading-tight">
              ...
              <span className="text-consulting-green">Exceptional Growth</span>
            </h1>
          ...
          <div className="relative">
            <div className="absolute -top-10 -left-10 w-32 h-32 bg-consulting-light-green/20 rounded-full blur-2xl"></div>
