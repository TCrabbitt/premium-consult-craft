          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-5xl mx-auto text-center space-y-10">
              <div className="inline-flex items-center bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-sm rounded-full px-8 py-4 text-base font-semibold mb-8 border border-white/20">
                ...
                Solution 1 • Global Recruitment Solutions
              </div>
              <h1 className="text-6xl lg:text-7xl font-display font-bold leading-tight">
                <span className="block text-white/90 text-2xl lg:text-3xl font-medium mb-4">Overseas Staffing Excellence</span>
                Your Trusted Partner in
                <span className="bg-gradient-to-r from-hallmark-light-green via-white to-hallmark-green bg-clip-text text-transparent block mt-2"> Global Hiring Solutions</span>
              </h1>
              ...
              <div className="mt-16 flex items-center justify-center space-x-8 text-white/80">
                <div className="flex items-center space-x-2">
                  <Star className="h-5 w-5 text-hallmark-green" />
                  <span className="text-sm font-medium">ISO Certified</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Globe className="h-5 w-5 text-hallmark-green" />
                  <span className="text-sm font-medium">7+ Countries</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Users className="h-5 w-5 text-hallmark-green" />
                  <span className="text-sm font-medium">1000+ Deployments</span>
                </div>
              </div>
            </div>
          </div>
